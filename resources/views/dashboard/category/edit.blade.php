                ...
                <div class="card-body">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input value='{{old('icon')??$category->icon}}' type="text" autofocus class="{{ $errors->has('icon')?"is-invalid":""}} form-control" id="icon" name="icon" placeholder="Enter Category icon">
                  </div>
