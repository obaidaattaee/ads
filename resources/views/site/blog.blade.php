        ...
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            ...
            <div class="row mb-3 align-items-stretch">
              @php $blogs = \App\Models\Post::get() @endphp
              @foreach ($blogs as $blog )
                   <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                  <div class="h-entry">
                    <img src="{{asset('classyads/images/hero_1.jpg')}}" alt="Image" class="img-fluid rounded">
                    <h2 class="font-size-regular"><a href="#" class="text-black">{{ $blog->title }}</a></h2>
                    <div class="meta mb-3">by Mark Spiker<span class="mx-1">&bullet;</span> {{ date('M',strtotime($blog->created_at))}}, {{ date('Y',strtotime($blog->created_at))}}<span class="mx-1">&bullet;</span> <a href="#">News</a></div>
